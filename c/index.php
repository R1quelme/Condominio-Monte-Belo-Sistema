...
<body>
  ...
  <script>
    ...
    function copiarTexto() {
      var textoCopiado = document.getElementById("url");
      textoCopiado.select();
      document.execCommand("Copy");
    }

    function geraURL(event) {
      event.preventDefault()
      $.ajax({
        url: "utills/funcoes.php",
        method: "POST",
        dataType: "JSON",
        data: {
          acao: 'token'
        ...
        success: function(dados) {
          if (dados.status == false) {
            ...
            $("#url").val("https://a934181054ed.ngrok.io/argon-dashboard-master/c/register.php?token=" + dados.Token)
          }
        },
        error: function() {
          alertaMensagem(dados.MSG, 'e')
        }
      })
    }
  </script>
